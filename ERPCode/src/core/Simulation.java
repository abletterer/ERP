...
//        
//        float test = configuration.getTempsConstruction()/(float)configuration.getTravailHeureJour()* (configuration.getStockMaxBobine()-configuration.getStockMinBobine()+configuration.getEnCoursBobine());
//        
